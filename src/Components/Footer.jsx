  ...
  return (
    ...
    >
      <div className="footer grid grid-cols-5  text-[#212121] pt-20 pb-4 px-4">
        <div className="left col-span-2 flex flex-col justify-between">
          <h1 className='font-["Test Founders Grotesk Semibold"] text-8xl font-semibold uppercase leading-[0.85] tracking-tighter'>
            Eye- Opening
          </h1>
        ...
        <div className="right col-span-3">
          <div className="heading">
            <h1 className='font-["Test Founders Grotesk Semibold"] text-8xl font-semibold uppercase leading-[0.85] -tracking-wider'>
              presentations
            </h1>
          </div>
          <div className='grid grid-cols-4 gap-2 font-[Test Founders Grotesk Semibold"]  text-lg tracking-tight'>
            <div className="right1 col-span-3 flex flex-col mt-6">
              <div className="socials mt-6 leading-[1.4] capitalize">
                <div>
                  <p className="mb-6">s:</p>
                </div>
                <div className="underline underline-offset-[3px] decoration-1">
                  <a href="">instagram</a>
                </div>
                <div className="underline underline-offset-[3px] decoration-1">
                  <a href="">behance</a>
              ...
              <div className="address mt-10 leading-[1.4] capitalize">
                <div>
                  <p className="mb-6">L:</p>
                </div>
                <div className="w-1/3">
                  <a
                    href=""
              ...
              <div className="email mt-4">
                <div>
                  <p className="my-6 capitalize">e:</p>
                </div>
                <a
                  href=""
            ...
            <div className="right2 font-['Test Founders Grotesk Semibold'] capitalize text-lg tracking-tight flex flex-col justify-end">
              <div>
                <p className="mb-6">m:</p>
              </div>
              <div className="lnk flex flex-col w-auto">
                <a
                  href=""
                  className="underline underline-offset-[3px] decoration-1 w-fit"
                >
                  home
                </a>
                <a
          ...
          <div className="end w-full flex justify-between text-zinc-400 text-lg mt-6">
            <div className=" flex items-center font-['Test Founders Grotesk Semibold']">
              <p>© ochi design clone 2024.</p>
              <p className="underline text-lg underline-offset-2 decoration-1">
                Legal Terms
              </p>
            </div>
            <div className="font-['Test Founders Grotesk Semibold']">
              <p>Website by Harshit ❤️</p>
            </div>
          </div>
        </div>
      </div>
