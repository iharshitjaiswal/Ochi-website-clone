...
const LandingPage = () => {
  return (
    <div
      data-scroll
      data-scroll-section
      data-scroll-speed="-0.33s"
      className="w-full h-screen bg-[#f1f1f1] text-[#212121] pt-1 relative"
    >
      <div className="textstructure mt-40 px-4">
        {["We create", "eye-opening", "presentations"].map((item, index) => {
          return (
            <div className="maskar">
              <div className="w-fit flex items-end overflow-hidden items-center">
                {index === 1 && (
                  <motion.div
                    initial={{ width: 0 }}
                    animate={{ width: "7.5vw" }}
                  ...
                  >
                    <img
                      src={ochi}
                      className="w-[7.5vw] relative  mt-3"
                      alt=""
                    />
                  </motion.div>
                )}
                <h1 className='text-[7vw] leading-[6vw] font-["Founders Grotesk X-Cond"]   uppercase -tracking-[0.3rem] font-semibold'>
                  {item}
                </h1>
              </div>
      ...
      <div className="border-t-[1px] border-zinc-400 mt-[8rem] flex justify-between items-center px-[3.1rem] py-[0.6rem]">
        {[
          "For public and private companies",
          "From the first pitch to IPO",
        ].map((item, index) => {
          return <p className="text-lg  tracking-tight leading-none">{item}</p>;
        })}
        <div className="start flex items-center gap-3 ">
          <div className="px-3 py-1 border-[2px]  rounded-full border-zinc-500 text-md uppercase w-full font-['Test Founders Grotesk']">
            start the project
          </div>
          <HiOutlineArrowUpRight className="w-[1.8rem] h-[1.8rem] p-[0.3rem]  border-[1.5px] rounded-full border-zinc-500" />
        </div>
      </div>
    </div>
  );
